...
class PointTest {
    ...
    private final Point p2 = new Point(-5, 2, 49);
    private final Point p3 = new Point(1, 2, 3);
    ...
    /**
     * Test method for {@link primitives.Point#distanceSquared(primitives.Point)} and {@link primitives.Point#distance(primitives.Point)}.
     */
    @Test
    void testDistance() {
        ...
        assertTrue(isZero(p1.distanceSquared(p3)),
